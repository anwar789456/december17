...
export default function Header({ sticky }) {
    ...
    const handleScroll = () => {
        ...
        if (window.scrollY > scrollBuffer || isActive || sticky || isSearchOpen) {
            setIsSticky(true);
        } else {
            setIsSticky(false);
        }
    ...
    const handleLinkClick = () => {
        localStorage.setItem('productsScrollPosition', 0);
    };
                    ...
                    <div className={styles.icons}>
                        <div className={styles.margedRight}>
                           ...
                           <div className={styles.cartIconDiv} onClick={toggleCart}>
                                ...
                                <h1 className={styles.PIcon}>Panier</h1>
                            </div>
